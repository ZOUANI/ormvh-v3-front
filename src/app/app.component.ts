...
export class AppComponent {
    ...
    constructor(private authService: AuthenticationService, public translateService: TranslateService, private userService: UserService) {
        ...
        this.languageItems = [
            {
                label: '',
                items: this.languages.map(lg => ({
                    label: lg.label,
                    routerLink: [],
                    command: () => translateService.use(lg.abbrv)
                })).concat()
                ,
        ...
        this.settingItems = [
            {
                label: '',
                items: [
                    {label: 'security', routerLink: 'resetPassword', icon: 'fa fa-lock'},
                    {label: 'profile', icon: 'fa fa-user', command: () => this.showProfil()}]
            },
            {
                label: '',
                items: [
