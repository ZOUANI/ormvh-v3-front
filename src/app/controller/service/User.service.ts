...
public findAllUsers():Observable<Array<UserVo>> {
  ...
  public editUser() {
  this.http.put<UserVo>('http://localhost:8080/generated/user/', this.user).subscribe(data=>{
  });
  ...
  myRoleClone.updatedByVo.username = role.updatedByVo.username;7
  myRoleClone.createdByVo.username = role.createdByVo.username;7
  return myRoleClone;
  }
